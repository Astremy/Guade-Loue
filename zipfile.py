...
class ZipFile:
    ...
    def extract(self, member, path=None, pwd=None,name=None):
        ...
        return self._extract_member(member, path, pwd,name)
    ...
    def _extract_member(self, member, targetpath, pwd,name=None):
